...
// The chrome the hover cards share — the panel and the fact block. Exported
// because the git view's commit card is built from them too.
export { Fact, HOVER_CARD_CONTENT_CLASS } from "./HoverCardParts";
